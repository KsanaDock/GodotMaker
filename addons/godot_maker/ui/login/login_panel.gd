@tool
extends Window
## GodotMaker 登录面板 — 仅逻辑，UI 由 login_panel.tscn 定义
...
func _try_load_logo() -> void:
	var tex := load("res://addons/godot_maker/icons/logo.png")
	if tex:
...
func _show_error(msg: String) -> void:
	_error_label.text = "[img=14]res://addons/godot_maker/icons/ui/triangle-alert.svg[/img] " + msg

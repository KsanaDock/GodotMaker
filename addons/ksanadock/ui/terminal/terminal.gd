...
const TerminalTabScene = preload("res://addons/ksanadock/ui/terminal/terminal_tab.tscn")
const SidebarItemScene = preload("res://addons/ksanadock/ui/terminal/terminal_sidebar_item.tscn")
